...
<link href="<?php echo admin_base_url('assets/back_end/css/bootstrap.css'); ?>" rel="stylesheet" type="text/css">
                        ...
                        <div class="text-center">
                          ...
                          <p>You can reset your password here.</p>
                            <div class="panel-body">
                              ...
                              <form class="form" method="POST"action="<?php echo base_url('login/lost_password_update'); ?>">
                                <fieldset>
